...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: daftar_buku.php?status=id_tidak_valid");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cover = $buku['cover']; // Default menggunakan cover yang lama
    ...
    if(isset($_FILES['bookImage']) && $_FILES['bookImage']['error'] == 0) {
        ...
        if(in_array($file_ext, $allowed_ext)) {
            ...
            if($file_size < 5000000) {
                ...
                if (!empty($buku['cover'])) {
                    $path_cover_lama = '../../../perpustakaan_daffa/jpg/cover/' . $buku['cover'];
                    if (file_exists($path_cover_lama)) {
                        unlink($path_cover_lama);
                    }
                }
                
                // Buat nama file unik untuk cover baru
    ...
    if (mysqli_query($koneksi, $sql)) {
        header("Location: daftar_buku.php?status=sukses_edit");
        exit();
    } else {
            ...
            <form id="editBookForm" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="judul" name="judul" class="form-control" required 
                               placeholder="Masukkan judul buku" value="<?php echo $buku['judul']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pengarang" name="pengarang" class="form-control" required 
                               placeholder="Masukkan nama pengarang" value="<?php echo $buku['pengarang']; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="penerbit" name="penerbit" class="form-control" required 
                               placeholder="Masukkan nama penerbit" value="<?php echo $buku['penerbit']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="tahun_terbit" name="tahun_terbit" class="form-control" 
                               min="1900" max="2025" required placeholder="Masukkan tahun terbit" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="genre" name="genre" class="form-control" required
                            placeholder="Masukkan genre buku" value="<?php echo $buku['genre']; ?>">
                        </input>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stok" name="stok" class="form-control" min="0" required 
                               placeholder="Masukkan jumlah stok" value="<?php echo $buku['stok']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="current-cover">
                        <p>Cover Saat Ini:</p>
                        <img src="../../../perpustakaan_daffa/jpg/cover/<?php echo $buku['cover']; ?>" 
                             alt="Cover Saat Ini" style="max-height: 200px; max-width: 100%;">
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-file-upload" id="dropArea">
                        ...
                        <div id="uploadText">
                            ...
                            <p class="upload-text">Klik untuk ganti cover buku</p>
                            <p class="upload-subtext">Format: JPG, PNG, GIF (Maks. 5MB)</p>
                        </div>
                        <div class="image-preview">
                            <img id="imagePreview" src="#" alt="Preview Cover" style="display: none;">
                        </div>
                    </div>
                </div>
