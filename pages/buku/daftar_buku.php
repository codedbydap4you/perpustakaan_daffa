...
// Penanganan hapus buku
if (isset($_GET['hapus'])) {
    $id_hapus = (int)$_GET['hapus'];
    
    // Dapatkan nama file cover untuk dihapus
    $query_cover = "SELECT cover FROM buku WHERE id = $id_hapus";
    $result_cover = mysqli_query($koneksi, $query_cover);
    $row_cover = mysqli_fetch_assoc($result_cover);
    
    // Hapus file cover jika ada
    if (!empty($row_cover['cover'])) {
        $path_cover = '../../../perpustakaan_daffa/jpg/cover/' . $row_cover['cover'];
    ...
    $query_hapus = "DELETE FROM buku WHERE id = $id_hapus";
    if (mysqli_query($koneksi, $query_hapus)) {
        // Redirect untuk refresh halaman
        header("Location: daftar_buku.php?status=sukses_hapus");
        exit();
    } else {
        header("Location: daftar_buku.php?status=gagal_hapus");
        exit();
    }
}
?>
    ...
    <button id="toggleSidebar">
        ...
        <div class="content">
            ...
            <div class="add-button-container">
                <a href="tambah_buku.php" class="add-button">
            ...
            <?php if (isset($_GET['status']) && $_GET['status'] == 'gagal_hapus'): ?>
                <div class="alert alert-danger">
                    <i class="fas fa-exclamation-circle"></i> Gagal menghapus buku. Silakan coba lagi.
                </div>
            <?php endif; ?>
